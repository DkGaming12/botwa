...
│➻ *${prefix}3d Anjay*
│➻ *${prefix}tlight Anjay*
│➻ *${prefix}lighttext Anjay*
│➻ *${prefix}crismes Anjay*
│➻ *${prefix}naruto Anjay*
│➻ *${prefix}goldbutton Anjay*
│➻ *${prefix}silverbutton Anjay*
│➻ *${prefix}flame Anjay*
│➻ *${prefix}leavest Anjay*
│➻ *${prefix}pubg Anjay/tes*
│➻ *${prefix}phlogo Anjay/tes*
│➻ *${prefix}glitch Anjay/tes/b*
│➻ *${prefix}retro Anjay/tes/b*
│➻ *${prefix}tts id Haii*
│➻ *${prefix}ttp Anjay*
│➻ *${prefix}cpaper Anjay*
├───────────────────
...
│➻ *${prefix}gantengcek Anjay*
│➻ *${prefix}cantikcek Aowkwok*
│➻ *${prefix}artinama Anjay*
│➻ *${prefix}persengay Topan*
│➻ *${prefix}pbucin Anjay*
│➻ *${prefix}bpfont Anjay*
│➻ *${prefix}textstyle Anjay*
...
│
│\`\`\`Gopay\`\`\`
│ *5k Invite Bot Ke Grup*
│ *10k Untuk menjadi Premium*
│\`\`\`Pulsa\`\`\`
│ *10k Invite Bot Ke Group*
│ *15k Untuk menjadi Premium*
┬
╰──────「 *BY ${name}* 」

Untuk Kelangsungan Hidup Bot Karna API-KEY Mahal:'
`
}
